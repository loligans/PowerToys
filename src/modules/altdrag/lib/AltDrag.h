...
interface __declspec(uuid("{965BC508-EE6D-42CE-9255-81F5BA076661}")) IAltDragCallback : public IUnknown
{
    ...
    IFACEMETHOD_(void, OnMouseDown)(MSLLHOOKSTRUCT info) = 0;
    IFACEMETHOD_(void, OnMouseUp)(MSLLHOOKSTRUCT info) = 0;
    IFACEMETHOD_(void, OnMouseMove)(MSLLHOOKSTRUCT info) = 0;
};
